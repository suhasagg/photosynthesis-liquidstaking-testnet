...
import (
	...
	photosynthesiskeeper "github.com/archway-network/archway/x/photosynthesis/keeper"
...
type ArchwayApp struct {
	*baseapp.BaseApp
	...
	PhotosynthesisKeeper photosynthesiskeeper.PhotosynthesisKeeper
...
func NewArchwayApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		trackingTypes.StoreKey, rewardsTypes.StoreKey, epochtypes.StoreKey, phototypes.StoreKey, icahosttypes.StoreKey,
	)
	...
	// Initialize the PhotosynthesisKeeper in app.go
	app.PhotosynthesisKeeper = photosynthesiskeeper.NewPhotosynthesisKeeper(
		appCodec,
		keys[phototypes.StoreKey],              // Store key for Photosynthesis module
		app.getSubspace(phototypes.ModuleName), // Subspace for parameters
		app.BankKeeper,                         // BankKeeper for handling transfers
		app.RewardsKeeper,                      // RewardsKeeper to manage rewards
		app.Logger(),                           // Logger for logging activities
	)
